...
pub struct ObjectDiff_UpsertObjectModification {
    // message fields
    fields_to_upsert: ::protobuf::RepeatedField<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry>,
...
impl ObjectDiff_UpsertObjectModification {
        ...
        unsafe {
            instance.get(|| {
                ObjectDiff_UpsertObjectModification {
                    fields_to_upsert: ::protobuf::RepeatedField::new(),
    ...
    // repeated .ObjectDiff.UpsertObjectModification.FieldsToUpsertEntry fields_to_upsert = 1;

    pub fn clear_fields_to_upsert(&mut self) {
        self.fields_to_upsert.clear();
    }

    // Param is passed by value, moved
    pub fn set_fields_to_upsert(&mut self, v: ::protobuf::RepeatedField<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry>) {
        self.fields_to_upsert = v;
    }

    // Mutable pointer to the field.
    pub fn mut_fields_to_upsert(&mut self) -> &mut ::protobuf::RepeatedField<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry> {
        &mut self.fields_to_upsert
    }

    // Take field
    pub fn take_fields_to_upsert(&mut self) -> ::protobuf::RepeatedField<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry> {
        ::std::mem::replace(&mut self.fields_to_upsert, ::protobuf::RepeatedField::new())
    }

    pub fn get_fields_to_upsert(&self) -> &[ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry] {
        &self.fields_to_upsert
    }
...
impl ::protobuf::Message for ObjectDiff_UpsertObjectModification {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !try!(is.eof()) {
            ...
            match field_number {
                1 => {
                    try!(::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.fields_to_upsert));
                },
                2 => {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in self.fields_to_upsert.iter() {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        for v in self.fields_to_upsert.iter() {
            try!(os.write_tag(1, ::protobuf::wire_format::WireTypeLengthDelimited));
            try!(os.write_raw_varint32(v.get_cached_size()));
            try!(v.write_to_with_cached_sizes(os));
        };
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_message_accessor(
                    "fields_to_upsert",
                    ObjectDiff_UpsertObjectModification::get_fields_to_upsert,
                ));
...
impl ::std::cmp::PartialEq for ObjectDiff_UpsertObjectModification {
    fn eq(&self, other: &ObjectDiff_UpsertObjectModification) -> bool {
        self.fields_to_upsert == other.fields_to_upsert &&
...
#[derive(Clone,Default)]
pub struct ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    // message fields
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {}

impl ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    pub fn new() -> ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
        static mut instance: ::protobuf::lazy::Lazy<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry,
        };
        unsafe {
            instance.get(|| {
                ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
...
impl ::protobuf::Message for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn type_id(&self) -> ::std::any::TypeId {
        ::std::any::TypeId::of::<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry>()
    }
...
impl ::protobuf::MessageStatic for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    fn new() -> ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
        ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry::new()
    }

    fn descriptor_static(_: ::std::option::Option<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor(
                    "key",
                    ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry::has_key,
                    ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry::get_key,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "value",
                    ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry::has_value,
                    ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry::get_value,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry>(
                    "ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    fn clear(&mut self) {
        self.clear_key();
        self.clear_value();
        self.unknown_fields.clear();
...
impl ::std::cmp::PartialEq for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    fn eq(&self, other: &ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry) -> bool {
        self.key == other.key &&
...
impl ::std::fmt::Debug for ObjectDiff_UpsertObjectModification_FieldsToUpsertEntry {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc4, 0x03, 0x0a, 0x0a, 0x4f, 0x62, 0x6a, 0x65, 0x63,
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    ,
];
